...
exports.postMobileRegister = async (req, res, next) => {
    ...
    try{
        ...
        if(currentUser && currentUser.isVerified){
            ...
            return res.status(200).json({ msg: 'Message sent',userId:currentUser._id});
            ...
            return res.status(201).json({ msg: 'OTP sent. Please Verify the mobile no.', status: "Mobile number registered", userId : result._id})
